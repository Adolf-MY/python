...
def change_resolution(picPath, reslution):
    ...
    if changex > 1 or changey > 1:
        ...
        img.resize((int(x / change), int(y / change))).save('E:/python/Users/Frank/PycharmProjects/python/showmithecode/0005/result.jpg')

if __name__ == '__main__':
    change_resolution('E:/python/Users/Frank/PycharmProjects/python/showmithecode/0005/aa.jpeg',(1136,640))
